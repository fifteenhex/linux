 ...
 */
static __nolibc_no_stack_protector
int __relocate_rel(unsigned long base, _nolibc_elf_rel *entry);

/* Generic implementation of R_x_RELATIVE for REL */
static __inline__ __nolibc_no_stack_protector
void __relocate_rel_relative(unsigned long base, _nolibc_elf_rel *entry)
{
 ...
 */
static __nolibc_no_stack_protector
int __relocate_rela(unsigned long base, _nolibc_elf_rela *entry);

/* Generic implementation of R_x_RELATIVE for RELA */
static __inline__ __nolibc_no_stack_protector
void __relocate_rela_relative(unsigned long base, _nolibc_elf_rela *entry)
{
	_nolibc_elf_addr *addr;
...
static __inline__ __nolibc_no_stack_protector
void _relocate(const unsigned long *auxv)
{
