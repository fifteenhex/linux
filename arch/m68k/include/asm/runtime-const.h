...
/*
 * andi.l #imm32,Dn is a single opcode word followed by the 32-bit immediate
 * (base instruction on all 68k, so no CONFIG_M68000 split needed).  Like the
 * ptr case the immediate sits at offset 2, patched at init.
 */
